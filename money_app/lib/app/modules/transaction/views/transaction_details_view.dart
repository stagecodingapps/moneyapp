      ...
      body: Column(
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                GetBuilder<TransactionController>(
                  id: 'amount',
                  builder: (_) {
                    var amount = controller.selectedTransaction.value.amount!;
          ...
          Padding(
            ...
            child: Text(
              dateFormat
                  .format(controller.selectedTransaction.value.createdAt!),
          ...
          Visibility(
            visible: controller.selectedTransaction.value.type == 'Payment',
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Padding(
                  padding: EdgeInsets.only(left: 20, top: 55, bottom: 5),
                  child: Text(
                    'SHARE THE COST',
                ...
                SizedBox(
                  height: 50,
                  child: TextButton(
                    onPressed: () => controller.toggleIsRepeatingPayment(null),
                    style: const ButtonStyle(
                      ...
                      children: [
                        ...
                        Obx(
                          () => Switch(
                            ...
                            onChanged: (value) =>
                                controller.toggleIsRepeatingPayment(value),
